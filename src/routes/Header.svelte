...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname.startsWith('/marketCoin') ? 'page' : undefined}>
				<a href="/marketCoin">Market-Coin</a>
			</li>
			<li aria-current={$page.url.pathname.startsWith('/gamePlants') ? 'page' : undefined}>
				<a href="/gamesPlants">Game-Plants</a>
			</li>
		</ul>
		<svg viewBox="0 0 2 3" aria-hidden="true">
